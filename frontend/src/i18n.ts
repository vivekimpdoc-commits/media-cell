...
const resources = {
  en: {
    translation: {
      ...
      "social.liveFeedAnalysis": "Live Feed Analysis",
      "social.trendingHashtags": "Trending Hashtags",
      "social.publicSentimentAnalysis": "Public & Media Sentiment Analysis",
      "social.fakeNewsAndRumorTracker": "Fake News & Rumor Tracker",
      "social.rumorContent": "Rumor Content",
      "social.originPlatform": "Origin Platform",
      "social.spreadSpeed": "Spread Speed",
      "social.aiVerification": "AI Verification",
      "social.action": "Action",
      "social.platformMonitored": "Platform Monitored",
      "social.deepfakeAlerts": "Deepfake / Bot Alerts",
      "social.darkWebMentions": "Dark Web Mentions",
      "social.liveFeedAnalysis": "Live Feed Analysis",
      "social.trendingHashtags": "Trending Hashtags",
      "social.searchPlaceholder": "Search keywords...",
      "social.uploadMedia": "Upload Media",
      "social.uploadSuccess": "Upload successful",
      "social.uploadFailed": "Upload failed",
      "social.last7Days": "Last 7 Days",
      "social.last30Days": "Last 30 Days",
      "social.thisYear": "This Year",
  ...
  hi: {
    translation: {
      ...
      "social.liveMonitoring": "लाइव मॉनिटरिंग",
      "social.detailedSentiment": "विस्तृत सेंटिमेंट",
      "social.fakeNewsTracker": "फेक न्यूज़ ट्रैकर",
      "social.platformMonitored": "प्लेटफ़ॉर्म मॉनिटर किया गया",
      "social.deepfakeAlerts": "डिपफ़ेक / बॉट अलर्ट",
      "social.darkWebMentions": "डार्क वेब उल्लेख",
      "social.liveFeedAnalysis": "लाइव फ़ीड विश्लेषण",
      "social.trendingHashtags": "ट्रेंडिंग हैशटैग",
      "social.searchPlaceholder": "कीवर्ड खोजें...",
      "social.uploadMedia": "मीडिया अपलोड करें",
      "social.uploadSuccess": "अपलोड सफल",
      "social.uploadFailed": "अपलोड विफल",
      "social.last7Days": "पिछले 7 दिन",
      "social.last30Days": "पिछले 30 दिन",
      "social.thisYear": "वर्तमान वर्ष",
